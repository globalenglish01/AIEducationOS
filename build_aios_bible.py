...
CHAPTER_META: list[dict] = [
    ...
    # Part 10: MCP
    {"n": 42, "node": "KN-C-000060", "part": "第十部分：MCP 与工具生态"},
    {"n": 43, "node": "KN-C-000061", "part": "第十部分：MCP 与工具生态"},
    {"n": 44, "node": "KN-C-000062", "part": "第十部分：MCP 与工具生态"},
    {"n": 45, "node": "KN-C-000063", "part": "第十部分：MCP 与工具生态"},
    {"n": 46, "node": "KN-C-000064", "part": "第十部分：MCP 与工具生态"},
    # Part 11: Memory
    {"n": 47, "node": "KN-C-000065", "part": "第十一部分：记忆与上下文管理"},
    {"n": 48, "node": "KN-C-000066", "part": "第十一部分：记忆与上下文管理"},
    {"n": 49, "node": "KN-C-000067", "part": "第十一部分：记忆与上下文管理"},
    {"n": 50, "node": "KN-C-000068", "part": "第十一部分：记忆与上下文管理"},
    # Part 12: Cost Optimization
    {"n": 51, "node": "KN-C-000069", "part": "第十二部分：成本优化"},
    {"n": 52, "node": "KN-C-000070", "part": "第十二部分：成本优化"},
    {"n": 53, "node": "KN-C-000071", "part": "第十二部分：成本优化"},
    {"n": 54, "node": "KN-C-000072", "part": "第十二部分：成本优化"},
    # Part 13: Deployment
    {"n": 55, "node": "KN-C-000073", "part": "第十三部分：部署与运维"},
    {"n": 56, "node": "KN-C-000074", "part": "第十三部分：部署与运维"},
    {"n": 57, "node": "KN-C-000075", "part": "第十三部分：部署与运维"},
    {"n": 58, "node": "KN-C-000076", "part": "第十三部分：部署与运维"},
    {"n": 59, "node": "KN-C-000077", "part": "第十三部分：部署与运维"},
    # Part 14: Governance
    {"n": 60, "node": "KN-C-000078", "part": "第十四部分：治理与合规"},
    {"n": 61, "node": "KN-C-000079", "part": "第十四部分：治理与合规"},
    {"n": 62, "node": "KN-C-000080", "part": "第十四部分：治理与合规"},
    # Part 15: Patterns
    {"n": 63, "node": "KN-P-000005", "part": "第十五部分：Agent 设计模式"},
    {"n": 64, "node": "KN-P-000006", "part": "第十五部分：Agent 设计模式"},
    {"n": 65, "node": "KN-P-000007", "part": "第十五部分：Agent 设计模式"},
    {"n": 66, "node": "KN-P-000008", "part": "第十五部分：Agent 设计模式"},
    {"n": 67, "node": "KN-P-000009", "part": "第十五部分：Agent 设计模式"},
    # Part 16: Frameworks
    {"n": 68, "node": "KN-F-000001", "part": "第十六部分：主流框架"},
    {"n": 69, "node": "KN-F-000002", "part": "第十六部分：主流框架"},
    {"n": 70, "node": "KN-F-000003", "part": "第十六部分：主流框架"},
    {"n": 71, "node": "KN-F-000004", "part": "第十六部分：主流框架"},
    {"n": 72, "node": "KN-F-000005", "part": "第十六部分：主流框架"},
    # Part 17: Tools
    {"n": 73, "node": "KN-T-000001", "part": "第十七部分：工具与基础设施"},
    {"n": 74, "node": "KN-T-000002", "part": "第十七部分：工具与基础设施"},
    {"n": 75, "node": "KN-T-000003", "part": "第十七部分：工具与基础设施"},
    # Part 18: Architectures
    {"n": 76, "node": "KN-A-000001", "part": "第十八部分：系统架构"},
    {"n": 77, "node": "KN-A-000002", "part": "第十八部分：系统架构"},
    # Part 19: Anti-patterns & Protocol
    {"n": 78, "node": "KN-X-000001", "part": "第十九部分：反模式与协议"},
    {"n": 79, "node": "KN-X-000002", "part": "第十九部分：反模式与协议"},
    {"n": 80, "node": "KN-R-000001", "part": "第十九部分：反模式与协议"},
    # Part 20: Practices
    {"n": 81, "node": "KN-B-000001", "part": "第二十部分：工程实践"},
    {"n": 82, "node": "KN-B-000002", "part": "第二十部分：工程实践"},
    {"n": 83, "node": "KN-B-000003", "part": "第二十部分：工程实践"},
    {"n": 84, "node": "KN-B-000004", "part": "第二十部分：工程实践"},
    {"n": 85, "node": "KN-B-000005", "part": "第二十部分：工程实践"},
    # Part 21: Case Studies
    {"n": 86, "node": "KN-S-000001", "part": "第二十一部分：真实案例"},
    {"n": 87, "node": "KN-S-000002", "part": "第二十一部分：真实案例"},
    {"n": 88, "node": "KN-S-000003", "part": "第二十一部分：真实案例"},
    {"n": 89, "node": "KN-S-000004", "part": "第二十一部分：真实案例"},
    {"n": 90, "node": "KN-S-000005", "part": "第二十一部分：真实案例"},
    # Part 22: Exercises
    {"n": 91, "node": "KN-E-000001", "part": "第二十二部分：实战练习"},
    {"n": 92, "node": "KN-E-000002", "part": "第二十二部分：实战练习"},
    {"n": 93, "node": "KN-E-000003", "part": "第二十二部分：实战练习"},
    {"n": 94, "node": "KN-E-000004", "part": "第二十二部分：实战练习"},
    {"n": 95, "node": "KN-E-000005", "part": "第二十二部分：实战练习"},
]
